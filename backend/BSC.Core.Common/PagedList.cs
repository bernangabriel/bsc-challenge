...
namespace BSC.Core.Common
{
    ...
    public class PagedList<T> : IPagedList<T>
    {
        ...
        [DataMember(Name = "totalItemCount")] public int TotalItemCount { get; set; }

        [DataMember(Name = "currentPage")] public int CurrentPage { get; set; }

        [DataMember(Name = "count")] public int Count { get; set; }

        [DataMember(Name = "pageCount")] public int PageCount { get; set; }
    }
}